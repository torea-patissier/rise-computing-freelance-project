...
const Cta = ({
  ...
  return (
     ...
     >
       <div className="">
         <div id="nous_contacter" className="nous-contacter">
           <h3 id="nos_parternaires" className="pt-32 container-sm reveal-from-bottom center-content"
         ...
         >
           <div className="cta-slogan">
             <div className="logo-contact">
               ...
               <h5 className="nous-contacter ml-16">06 81 23 43 23</h5>
             </div>
             <div className="logo-contact">
               <svg width="32" height="32" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path d="M45 11.25C30.5025 11.25 18.75 22.6849 18.75 36.7905C18.75 48.9054 38.1133 71.1616 43.579 77.2025C44.3513 78.0561 45.6487 78.0561 46.421 77.2025C51.8867 71.1616 71.25 48.9054 71.25 36.7905C71.25 22.6849 59.4975 11.25 45 11.25Z" stroke="#F4F4F4" stroke-width="2"/>
           ...
           <div className="cta-action text-xs testimonial-item-content tiles-item-inner form-contact">
             <form className="caze" action="submit_form.php" method="post">
               <Input type="email" label="Subscribe" labelHidden hasIcon="right" placeholder="Your best email"></Input>
               <input  className="input-form-contact" type="text" id="nom" placeholder="Nom" name="nom"/><br/><br/>
               <input type="text" id="telephone" placeholder="Téléphone" name="telephone"/><br/><br/>
               <input type="email" id="mail" placeholder="Email" name="mail"/><br/><br/>
               <textarea id="message" placeholder="Message" name="message"/><br/><br/>
